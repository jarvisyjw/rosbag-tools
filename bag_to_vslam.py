...
def extract_images_for_vslamlab(bag_file: Bag, topic: str, output_dir: str):
    sequence_dir = osp.join(output_dir, 'sequence_01')
...
if __name__ == '__main__':
    ...
    with Bag(args.bag_file, 'r') as bag:
        extract_images_for_vslamlab(bag, args.topic, args.output_dir)
